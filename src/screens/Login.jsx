      ...
      >
        ...
        <div style={{ position: 'relative', padding: '20px 24px 12px', flexShrink: 0 }}>
          ...
          <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', whiteSpace: 'nowrap' }}>
            ...
            <span style={{ fontSize: 17, fontWeight: 700, letterSpacing: -0.6, background: 'linear-gradient(135deg,#60a5fa 0%,#10b981 100%)', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent', filter: 'drop-shadow(0 0 20px rgba(16,185,129,.6))' }}>Services Inc.</span>
          </div>
        ...
        <div style={{
          ...
          <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
              <div>
                <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: 1.2, color: '#60a5fa' }}>EMPLOYEE SIGN-IN</div>
                ...
                {[0,1,2,3,4,5].map((i) => {
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      {filled ? '•' : active ? <div style={{ width: 2, height: 18, background: '#3b82f6', borderRadius: 2, animation: 'tsCaret 1.1s ease-in-out infinite', boxShadow: '0 0 6px 1px rgba(37,99,235,.7)' }} /> : null}
                    </div>
                  )
                })}
              </div>
            ...
            <div style={{ marginTop: 10, textAlign: 'center' }}>
              <Link to="/login" style={{
                textDecoration: 'none',
                fontSize: 11, fontWeight: 800, letterSpacing: 1.2, color: '#60a5fa',
              }}>
                GO TO ADMIN SIGN-IN
              </Link>

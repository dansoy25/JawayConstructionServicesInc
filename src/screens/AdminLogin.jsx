      ...
      <div className="ts-admin-right" style={{
        ...
        <div style={{ maxWidth: 460, width: '100%', margin: '0 auto' }}>
          ...
          <div style={{ marginTop: 28, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            <button type="button" onClick={() => showSSOToast('Google')} className="ts-sso-d" style={ssoBtn}>
            ...
            <button type="button" onClick={() => showSSOToast('Microsoft')} className="ts-sso-d" style={ssoBtn}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '22px 0' }}>
            ...
            <div style={{ fontSize: 10, fontWeight: 700, color: '#475569', letterSpacing: 1 }}>OR SIGN IN WITH ID</div>
            <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,.08)' }} />
          </div>
